...
export default function Menu() {
  ...
  return (
   ...
   <div className="text-white w-[1200px] m-auto py-10 px-4">
      <h1 className="text-4xl text-center font-bold italic mb-8">Меню на неделю</h1>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-[90%] max-w-md text-blue-950">
            <h2 className="text-xl font-bold mb-4">
              Редактировать меню: {menuData[selectedDayIndex].date.format("dd, D MMMM")}
            </h2>
